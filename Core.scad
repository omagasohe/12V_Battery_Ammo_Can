...
difference(){
    union()
    {
        if(Render_Top_Cell_Holder)
            ...
            rounded_4s_Cube([((Cell_Diameter+Cell_Spacing)*Core_Columns)-Cell_Spacing+Pack_Padding+Pack_Padding, ((Cell_Diameter+Cell_Spacing)*Core_Rows)-Cell_Spacing+Pack_Padding+Pack_Padding,Pack_Padding_Cell_Side+Strap_Thickness],5);
